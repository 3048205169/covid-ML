...
if __name__ =="__main__":
    china_cases = pd.read_csv("China_cases.csv")
    china_cases = china_cases.loc[0:120]
    china_cases_1 = compress_china_cases(china_cases,6)
    ...
    china_cases_2 = compress_china_cases(china_cases,4)
